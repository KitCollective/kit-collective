...
- Vendor research field catalog (KIT-138): [field-catalog.md](./field-catalog.md). Focused FK catalog (KIT-140): [fk-field-catalog.md](./fk-field-catalog.md). Join compose catalog (KIT-145): [compose-catalog.md](./compose-catalog.md). Seed references: `seed/apify/reference.md`, `seed/fkapi/reference.md`. Postgres landing: [schema-gap.md](./schema-gap.md).
