...
**Forbidden (ADR-0002):** market value, agent PII, TM branding URLs (`tmLogoUrl`, profile URLs as product assets). Club/league/honour **bytes** may land on `catalog_mark` (admin_only), never as hot-linked TM URLs.  
...
| CLI (Hierarchy grains) | `seed-apify grain league <competition> [lane]` · `seed-apify grain league-season <competition> <season> [lane]` · `seed-apify grain club <competition> <clubId> [lane]` · `seed-apify grain club-season <competition> <clubId> <season> [lane]` · `seed-apify grain club-proof <competition> <season> [lane]` · `seed-apify grain national-team <ntRef> [lane]` · `seed-apify grain national-team-season <ntRef> <season> [lane]` · `seed-apify grain national-team-proof <ntRef> <season> [lane]` |
