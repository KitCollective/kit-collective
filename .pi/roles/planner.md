...
Tools: pinned Linear CLI only. No file tools. No general bash. No browser tools. Never set Linear Agent to Cursor. Never merge. Never claim Triage. Never move to In Review, Ready for merge, Merging, Done, Parked, or Canceled. Intake is a separate hourly job on this mutex.
