...
- Health: `https://harness.eskobar.dev/health` → `{"ok":true,"planner":"active","job":{"role":"implement","identifier":"KIT-n"}|null,"capacity":{"ramFreeMb":4096,"diskFreeMb":10240,"ready":true}}` HTTP 200 while the process is up. `job` is the Coding job occupying the slot (implement / factory-checker / land) or `null`. Capacity is always-ready in this slice. Never 503 because a job is running.
