...
For the current seam / slice, spawn **every** helper whose `description` matches (labels, apps, stack). Skip files whose description is not this job (planner, checker, release).
